...
class PhrasesControllerTest < ActionController::TestCase
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post :create, phrase: { author: @phrase.author, content: @phrase.content, language: @phrase.language }
    end
  ...
  test "should update phrase" do
    patch :update, id: @phrase, phrase: { author: @phrase.author, content: @phrase.content, language: @phrase.language }
    assert_redirected_to phrase_path(assigns(:phrase))
  end
